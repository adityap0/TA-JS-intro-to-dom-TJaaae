...
let topics = document.body.querySelector('ul');
// 6. Select the first label element and store in `label`
let label = document.body.children[6].children[1].innerText;
...
let attrPassword = document.querySelector('#password').placeholder;
...
let num = document.querySelectorAll('img');
console.log(num.length);
// 16. Select all the `p` element and store in `allPElement`
let allPElement = document.querySelectorAll('p');
// 17. Select all the buttons and log the count of buttons.
let num_buttons = document.querySelectorAll('button');
...
typeof document.querySelector('.topics').lastElementChild;
